...
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_00024Companion_nativeCreateVolume(JNIEnv *env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_00024Companion_nativeInit(JNIEnv *env, jobject clazz,
                                                      jstring jroot_cipher_dir,
                                                      jbyteArray jpassword,
...
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1is_1closed(JNIEnv *env, jobject thiz,
                                                                    jint sessionID) {
    return gcf_is_closed(sessionID);
}

JNIEXPORT jboolean JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_00024Companion_changePassword(JNIEnv *env, jclass clazz,
                                                                               jstring jroot_cipher_dir,
...
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1close(JNIEnv *env, jobject thiz, jint sessionID) {
    gcf_close(sessionID);
}

JNIEXPORT jobject JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1list_1dir(JNIEnv *env, jobject thiz,
    ...
    if (elements.r0 != NULL) {
        ...
        jclass classExplorerElement = (*env)->NewLocalRef(env, (*env)->FindClass(env, "me/zhanghai/android/files/provider/gocryptfs/client/GocryptfsEntry"));
        jmethodID explorerElementNew = (*env)->GetStaticMethodID(env, classExplorerElement, "new", "(Ljava/lang/String;IJJLjava/lang/String;)Lme/zhanghai/android/files/provider/gocryptfs/client/GocryptfsEntry;");
...
JNIEXPORT jobject JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1get_1attr(JNIEnv *env, jobject thiz,
    ...
    if (attrs.r3 == 1) {
        jclass stat = (*env)->FindClass(env, "me/zhanghai/android/files/provider/gocryptfs/client/GocryptfsStat");
...
JNIEXPORT jint JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1open_1read_1mode(JNIEnv *env, jobject thiz,
                                                                         jint sessionID,
                                                                         jstring jfile_path) {
    const char* file_path = (*env)->GetStringUTFChars(env, jfile_path, NULL);
    GoString go_file_path = {file_path, strlen(file_path)};
...
JNIEXPORT jint JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1open_1write_1mode(JNIEnv *env, jobject thiz,
                                                                          jint sessionID,
                                                                          jstring jfile_path,
                                                                          jint mode) {
    const char* file_path = (*env)->GetStringUTFChars(env, jfile_path, NULL);
...
JNIEXPORT jint JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1write_1file(JNIEnv *env, jobject thiz,
...
JNIEXPORT jint JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1read_1file(JNIEnv *env, jobject thiz,
                                                           jint sessionID, jint handleID, jlong file_offset,
...
JNIEXPORT jboolean JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1truncate(JNIEnv *env, jobject thiz,
                                                                  jint sessionID,
                                                                  jstring jpath,
                                                                  jlong offset) {
...
JNIEXPORT void JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1close_1file(JNIEnv *env, jobject thiz,
                                                                         jint sessionID,
                                                                         jint handleID) {
...
JNIEXPORT jboolean JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1remove_1file(JNIEnv *env, jobject thiz,
                                                                     jint sessionID, jstring jfile_path) {
    const char* file_path = (*env)->GetStringUTFChars(env, jfile_path, NULL);
    GoString go_file_path = {file_path, strlen(file_path)};
...
JNIEXPORT jboolean JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1mkdir(JNIEnv *env, jobject thiz,
...
JNIEXPORT jboolean JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1rmdir(JNIEnv *env, jobject thiz,
...
JNIEXPORT jboolean JNICALL
Java_me_zhanghai_android_files_provider_gocryptfs_client_GocryptfsVolume_native_1rename(JNIEnv *env, jobject thiz,
